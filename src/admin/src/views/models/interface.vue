...
function generateApiKey() {
  ...
  // 只取UUID的前16位作为API Key
  formInline.externalApiKey = uuid.replace(/-/g, '').substring(0, 16);
  ElMessage.success('已生成随机API密钥');
}
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            ...
            >
              <div class="flex">
                <el-input
                  v-model="formInline.externalApiKey"
                  placeholder="请填写外部API认证密钥"
                  clearable
                />
                <el-button @click="generateApiKey" type="primary" class="ml-2">
