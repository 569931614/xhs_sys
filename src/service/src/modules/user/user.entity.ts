...
import { ChannelLevel } from '../invitation/channel-level.entity';
...
export class UserEntity extends BaseEntity {
  ...
  @Column({ comment: '用户类型ID', nullable: true })
  userType: number;

  @Column({ comment: '渠道等级ID', nullable: true })
  channelLevelId: number;

  @ManyToOne(() => ChannelLevel)
  @JoinColumn({ name: 'channelLevelId' })
  ...
  // 作为被邀请者收到的邀请
  @OneToMany(() => InvitationEntity, (invitation) => invitation.invitee)
