...
const channel_level_entity_1 = require("../invitation/channel-level.entity");
...
__decorate([
    (0, typeorm_1.Column)({ comment: '用户类型ID', nullable: true }),
    __metadata("design:type", Number)
], UserEntity.prototype, "userType", void 0);
__decorate([
    (0, typeorm_1.Column)({ comment: '渠道等级ID', nullable: true }),
    __metadata("design:type", Number)
], UserEntity.prototype, "channelLevelId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => channel_level_entity_1.ChannelLevel),
    (0, typeorm_1.JoinColumn)({ name: 'channelLevelId' }),
    __metadata("design:type", channel_level_entity_1.ChannelLevel)
], UserEntity.prototype, "channelLevel", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => invitation_entity_1.InvitationEntity, (invitation) => invitation.inviter),
    __metadata("design:type", Array)
], UserEntity.prototype, "sentInvitations", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => invitation_entity_1.InvitationEntity, (invitation) => invitation.invitee),
    __metadata("design:type", Array)
], UserEntity.prototype, "receivedInvitations", void 0);
