...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 0, description: 'App应用是否是GPTs', required: false }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], QuerAppDto.prototype, "isGPTs", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '', description: 'GPTs 的调用ID', required: false }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], QuerAppDto.prototype, "gizmoID", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 0, description: 'App应用是否是固定使用模型', required: false }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], QuerAppDto.prototype, "isFixedModel", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '', description: 'App应用使用的模型', required: false }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], QuerAppDto.prototype, "appModel", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '这是一句示例数据', description: 'app示例数据', required: false }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], QuerAppDto.prototype, "demoData", void 0);
