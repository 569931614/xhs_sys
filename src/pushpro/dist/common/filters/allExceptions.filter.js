...
let AllExceptionsFilter = class AllExceptionsFilter {
        ...
        const isApiRequest = request.url.includes('/api/') ||
            ...
            ((_a = request.originalUrl) === null || _a === void 0 ? void 0 : _a.includes('/api/')) ||
            ((_b = request.originalUrl) === null || _b === void 0 ? void 0 : _b.includes('/official/'));
        if (status === common_1.HttpStatus.NOT_FOUND && !isApiRequest) {
            response.redirect('/');
        }
        else {
